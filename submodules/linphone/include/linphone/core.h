...
LINPHONE_PUBLIC void  linphone_core_ping_options(LinphoneCore *lc,const LinphoneAddress *addr);
LINPHONE_PUBLIC void linphone_core_ping_add_heard_options(LinphoneCore *lc,const LinphoneAddress *addr,const char*hear,const char*real);
